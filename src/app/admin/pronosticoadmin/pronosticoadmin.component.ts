...
export class PronosticoadminComponent implements OnInit {
  ...
  public jugadasName : any;

  public tipoDeJugada : any;

  public typePlay : string = 'unica'

  public ganadorRace : any;
  ...
  whatJugadaIS(item){
    ...
    console.log(item.detail.value.type)

    if(item.detail.value.type === 'unica'){
      this.typePlay = 'unico'
      console.log('hello')
    }else{
      this.typePlay = 'multiple'
    }
  }
  ...
  this.app.getJugadasname().subscribe(item =>{
    this.jugadasName = item
  })
}
  ...
  onUpload(e){
   ...
   ngMode($event){
     console.log('cambiastes')
   }

   carrera1Reorder(event) {


    const itemMove = this.race1.splice(event.detail.from, 1)[0];
    this.race1.splice(event.detail.to, 0, itemMove);
    event.detail.complete();

}

    carrera2Reorder(event) {


      const itemMove = this.race2.splice(event.detail.from, 1)[0];
      this.race2.splice(event.detail.to, 0, itemMove);
      event.detail.complete();

 }

 carrera3Reorder(event) {


  const itemMove = this.race3.splice(event.detail.from, 1)[0];
  this.race3.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera4Reorder(event) {


  const itemMove = this.race4.splice(event.detail.from, 1)[0];
  this.race4.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera5Reorder(event) {


  const itemMove = this.race5.splice(event.detail.from, 1)[0];
  this.race5.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera6Reorder(event) {


  const itemMove = this.race6.splice(event.detail.from, 1)[0];
  this.race6.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}
carrera7Reorder(event) {


  const itemMove = this.race7.splice(event.detail.from, 1)[0];
  this.race7.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera8Reorder(event) {


  const itemMove = this.race8.splice(event.detail.from, 1)[0];
  this.race8.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera9Reorder(event) {


  const itemMove = this.race9.splice(event.detail.from, 1)[0];
  this.race9.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera10Reorder(event) {


  const itemMove = this.race10.splice(event.detail.from, 1)[0];
  this.race10.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera11Reorder(event) {


  const itemMove = this.race11.splice(event.detail.from, 1)[0];
  this.race11.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera12Reorder(event) {


  const itemMove = this.race12.splice(event.detail.from, 1)[0];
  this.race12.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera13Reorder(event) {


  const itemMove = this.race13.splice(event.detail.from, 1)[0];
  this.race13.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}
carrera14Reorder(event) {


  const itemMove = this.race14.splice(event.detail.from, 1)[0];
  this.race14.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera15Reorder(event) {


  const itemMove = this.race15.splice(event.detail.from, 1)[0];
  this.race15.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera16Reorder(event) {


  const itemMove = this.race16.splice(event.detail.from, 1)[0];
  this.race16.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera17Reorder(event) {


  const itemMove = this.race17.splice(event.detail.from, 1)[0];
  this.race17.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera18Reorder(event) {


  const itemMove = this.race18.splice(event.detail.from, 1)[0];
  this.race18.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera19Reorder(event) {


  const itemMove = this.race19.splice(event.detail.from, 1)[0];
  this.race19.splice(event.detail.to, 0, itemMove);
  event.detail.complete();

}

carrera20Reorder(event) {
...
carrera21Reorder(event) {
  ...
  event.detail.complete();
   ...
   carrera1Change(){
    ...
    this.carrera1 = {raceName:'C1', pick : this.race1 }
    ...
    carrera2Change(){
     ...
     this.carrera2 = {raceName:'C2', pick : this.race2 }
     ...
     this.carrera3 = {raceName:'C3', pick : this.race3 }
     ...
     this.carrera4 = {raceName:'C4', pick : this.race4 }
     ...
     this.carrera5 = {raceName:'C5', pick : this.race5 }
     ...
     this.carrera6 = {raceName:'C6', pick : this.race6 }
     }

     carrera7Change(){
 
      console.log( this.race7)
     this.carrera7 = {raceName:'C7', pick : this.race7 }
     }

     carrera8Change(){
 
      console.log( this.race8)
     this.carrera8 = {raceName:'C8', pick : this.race8 }
     }

     carrera9Change(){
 
      console.log( this.race9)
     this.carrera9 = {raceName:'C9', pick : this.race9 }
     }

     carrera10Change(){
 
      console.log( this.race10)
     this.carrera10 = {raceName:'C10', pick : this.race10 }
     }
     ...
     this.carrera11 = {raceName:'C11', pick : this.race11 }
     }

     carrera12Change(){
 
      console.log( this.race12)
     this.carrera12 = {raceName:'C12', pick : this.race12 }
     }

     carrera13Change(){
 
      console.log( this.race13)
     this.carrera13 = {raceName:'C13', pick : this.race13 }
     }

     carrera14Change(){
 
      console.log( this.race14)
     this.carrera14 = {raceName:'C14', pick : this.race14 }
     }

     carrera15Change(){
 
      console.log( this.race15)
     this.carrera15 = {raceName:'C15', pick : this.race15 }
     }

     carrera16Change(){
 
      console.log( this.race16)
     this.carrera16 = {raceName:'C16', pick : this.race16 }
     }

     carrera17Change(){
 
      console.log( this.race17)
     this.carrera17 = {raceName:'C17', pick : this.race17 }
     }

     carrera18Change(){
 
      console.log( this.race18)
     this.carrera18 = {raceName:'C18', pick : this.race18 }
     }

     carrera19Change(){
 
      console.log( this.race19)
     this.carrera19 = {raceName:'C19', pick : this.race19 }
     }

     carrera20Change(){
 
      console.log( this.race20)
     this.carrera20 = {raceName:'C20', pick : this.race20 }
     }

     carrera21Change(){
 
      console.log( this.race21)
     this.carrera21 = {raceName:'C21', pick : this.race21 }
     }
            ...
            if(this.type === 'Pronostico'){
              ...
              if(this.typePlay === 'multiple'){
                this.db.collection('pronostico').add({
                  ...
                  year:year,
                  picks:this.myPick,
                  photoPick:this.userAny.pickPhoto,
                  tipoJugada:this.tipoDeJugada.name,
                  name:this.pais,
