...
@NgModule({
  ...
  entryComponents: [EpisodioComponent,HipodromoComponent,AccComponent, AddEpisodioComponent, RedesComponent,EncuestasComponent,
    ...
    OptimizacionComponent, MisionvisionComponent, HowToComponent],


  imports: [BrowserModule, IonicModule.forRoot(), AppRoutingModule,FormsModule,
    AngularFireModule.initializeApp(firebaseConfig),IonicStorageModule.forRoot(),
    AngularFireAnalyticsModule,PipeModule,DragDropModule ,InfiniteScrollModule ,CloudflareStreamModule,
 
   AngularFireAuthModule, AngularFirestoreModule],
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },Downloader,/* GooglePlus,AdMobFree,*/InAppBrowser, VideoEditor, Globalization ],
