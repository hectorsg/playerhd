...
import { ProninterComponent } from './modales/proninter/proninter.component';
...
@NgModule({
  declarations: [AppComponent,EpisodioComponent,SafePipe,HipodromoComponent,EncuestasComponent, AccComponent,
    ...
    AtreveanarrarComponent, EnvivoAdminComponent, NewsAdminComponent, OptimizacionComponent,MisionvisionComponent, HowToComponent,
     StreamadminComponent,IntersitialComponent,PicksComponent, ProninterComponent, RetroAdminComponent,AllpicksComponent],
  ...
  entryComponents: [EpisodioComponent,HipodromoComponent,AccComponent, AddEpisodioComponent, RedesComponent,EncuestasComponent,
    ...
    OptimizacionComponent, MisionvisionComponent, HowToComponent, StreamadminComponent, IntersitialComponent,PicksComponent,ProninterComponent,
  RetroAdminComponent, AllpicksComponent],
