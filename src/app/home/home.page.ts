...
export class HomePage {
  ...
  constructor(public modal : ModalController, public menu:MenuController, public app : TriviaService,
              ...
              private videoEditor: VideoEditor, public pussh : PushnotficacionsService, public platform : Platform, private storageInterna: Storage) {
  ...
  async darlePlayalVideo(){
    ...
    var playy = setInterval(()=>{
      ...
      if(this.knowIfPlay === true){
        ...
        console.log('revive')
        document.getElementById("enVivoActtion").click();
      }
