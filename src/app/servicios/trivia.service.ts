...
export class TriviaService {
  ...
  constructor(private angularFireDatabase: AngularFireDatabase,private storage: AngularFireStorage,
    ...
    getEpisodio(){
      ...
      return this.db.collection('episodios', ref=> ref.where('destacado','==',false)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
    ...
    getJugadaSponsor(){
      ...
      return this.db.collection('jugadaSponsor').snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getJugadaSponsorByPais(item){

      return this.db.collection('jugadaSponsor', ref => ref.where('pais', '==',item)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getHipodromoEspecific(nombre){

      return this.db.collection('hipodromos', ref => ref.where('nombre', '==',nombre)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getadTransmision(){
      ...
      return this.db.collection('streamAd').snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getEpisodiobyHoy(date){
      return this.db.collection('episodios', ref => ref.where('longDate', '==',date).where('destacado','==',false)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getEpisodiobyCat(date){
      return this.db.collection('episodios', ref => ref.where('categoria', '==',date).where('destacado','==',false)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getEpisodiobyPais(pais){
      return this.db.collection('episodios', ref => ref.where('pais', '==',pais).where('destacado','==',false)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getEpisodiobyNombre(nombre){
      return this.db.collection('episodios', ref => ref.where('nombre', '==',nombre).where('destacado','==',false)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getMisEpisodios(userId){
      return this.db.collection('users').doc(userId).collection('vermastarde', ref => ref.orderBy('fecha', 'desc')).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getPronosticoByPais(item, filter){
      return this.db.collection('pronostico', ref => ref.where('pais','==',item).where('type','==','Pronostico').where('fecha','==',filter)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getRetros(){
      return this.db.collection('retrospectosArray', ref => ref.orderBy('spot', 'asc')).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getRetrosByPais(item){
      return this.db.collection('retrospectosArray', ref => ref.where('pais','==',item)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getJugadasname(){
      return this.db.collection('tiposDeJugada').snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
    ...
    getPulse(name){
      return this.db.collection('pulse', ref => ref.where('name','==',name)).snapshotChanges().pipe(map(item => {
        return item.map(a => {
          const data = a.payload.doc.data() as item;
          data.id = a.payload.doc.id;
          return data;
